...
def formas():
    ...
    limite_centro = pygame.draw.line(scr,(255,255,255),(width/2,altura_sup),(width/2,altura_inf))
...
fonteG = pygame.font.SysFont('arial',50,bold=True,italic=True)#fonte de texto
...
while True:
    ...
    if j1>=P_max or j2>=P_max:
        if j1>j2:
            ...
            textoV = fonteG.render(mensagemVence, True, (0,255,0))
        if j2>j1:
            Vencedor='Jogador 2 venceu!'
            mensagemVence = f'{Vencedor}'
            textoV = fonteG.render(mensagemVence, True, (255,0,0))
        scr.blit(textoV, (300, 500))
        reset()
        pygame.display.flip() 
